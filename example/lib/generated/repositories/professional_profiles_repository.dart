...
class ProfessionalProfilesRepository extends BaseRepository<ProfessionalProfilesModel> {
  ...
  Future<ProfessionalProfilesModel?> update(ProfessionalProfilesModel model) async {
    if (model.professionalId == null) {
      throw ArgumentError("Primary key professional_id cannot be null for update operation");
    }
  ...
  Future<List<UsersModel>> findByProfessionalId(String professionalId) async {
